...
const SLIDES = [{"accent": "#10b981", "icon": "\ud83d\udccb", "title": "Store contracts\nsecurely", "desc": "Upload and organize all your contracts, agreements, and legal documents in one private vault."}, {"accent": "#059669", "icon": "\ud83d\udd14", "title": "Never miss\na renewal", "desc": "Set expiry dates and get alerts before contracts expire. Stay on top of every agreement."}, {"accent": "#065f46", "icon": "\ud83d\udd12", "title": "Private and\nencrypted", "desc": "Your documents never leave your device. Complete privacy with zero cloud storage."}];
export function Onboarding({ onDone }: { onDone: () => void }) {
  const [idx, setIdx] = useState(0);
  const slide = SLIDES[idx];
  return (
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', background:'#080f08', position:'relative' }}>
